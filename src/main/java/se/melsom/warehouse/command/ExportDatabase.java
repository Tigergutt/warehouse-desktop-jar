...
public class ExportDatabase extends Command {
    ...
    public ExportDatabase(ApplicationPresentationModel controller) {
	...
	public void execute() {
		...
		String directory = persistentSettings.getProperty("exportDirectory", ".");
		...
		persistentSettings.setProperty("exportDirectory", chooser.getSelectedFile().getParent());
 	}
